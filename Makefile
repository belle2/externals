...
$(EXTSRCDIR)/MillepedeII/WIKI:
	...
	@cd $(EXTSRCDIR) && $(EXTDIR)/download.sh MillepedeII_V04-01-01.tgz svn:checkout:118:http://svnsrv.desy.de/public/MillepedeII/tags/V04-01-01
	@mv $(EXTSRCDIR)/V04-01-01 $(EXTSRCDIR)/MillepedeII
