...
COMMON_PACKAGES:=pkg-config-wrapper ninja gmp mpfr mpc isl gcc binutils zlib bzip2 xz lz4 curl git libxml2 libxslt \
    ...
    flc belle_legacy fann pandoc fastjet roounfold functionalplus frugally-deep \
    whizard
