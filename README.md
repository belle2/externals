...
| [autopep8](https://pypi.org/project/autopep8/) | A tool that automatically formats Python code to conform to the PEP 8 style guide | 2.2.0 | MIT  |
...
| [filelock](https://pypi.org/project/filelock/) | A platform independent file lock. | 3.14.0 | The |
...
| [jupyterlab](https://pypi.org/project/jupyterlab/) | JupyterLab computational environment | 4.2.1 | BSD  |
...
| [prompt-toolkit](https://pypi.org/project/prompt-toolkit/) | Library for building powerful interactive command lines in Python | 3.0.45 | BSD  |
...
| [pytorch-lightning](https://pypi.org/project/pytorch-lightning/) | PyTorch Lightning is the lightweight PyTorch wrapper for ML researchers | 2.2.5 | Apache-2.0 |
...
| [zipp](https://pypi.org/project/zipp/) | Backport of pathlib-compatible object wrapper for zip files | 3.19.1 | MIT  |
