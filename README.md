...
| [pip](https://pypi.org/project/pip/) | The PyPA recommended tool for installing Python packages | 24.0 | MIT |
| [setuptools](https://pypi.org/project/setuptools/) | Easily download, build, install, upgrade, and uninstall Python packages | 70.0.0 | MIT  |
| [absl-py](https://pypi.org/project/absl-py/) | Abseil Python Common Libraries, see https://github | 2.1.0 | Apache 2.0 |
...
| [anyio](https://pypi.org/project/anyio/) | High level compatibility layer for multiple asynchronous event loop implementations | 4.3.0 | MIT |
| [appdirs](https://pypi.org/project/appdirs/) | A small Python module for determining appropriate platform-specific dirs, e | 1.4.4 | MIT |
...
| [argparse-dataclass](https://pypi.org/project/argparse-dataclass/) | Declarative CLIs with argparse and dataclasses | 2.0.0 | MIT  |
...
| [autopep8](https://pypi.org/project/autopep8/) | A tool that automatically formats Python code to conform to the PEP 8 style guide | 2.1.0 | MIT  |
| [awkward](https://pypi.org/project/awkward/) | Manipulate JSON-like data with NumPy-like idioms | 2.6.4 | BSD-3-Clause |
| [awkward-cpp](https://pypi.org/project/awkward-cpp/) | CPU kernels and compiled extensions for Awkward Array | 33 | BSD-3-Clause |
...
| [blosc2](https://pypi.org/project/blosc2/) | Python wrapper for the C-Blosc2 library | 2.6.2 | BSD-3-Clause |
...
| [certifi](https://pypi.org/project/certifi/) | Python package for providing Mozilla's CA Bundle | 2024.2.2 | MPL-2.0 |
...
| [CherryPy](https://pypi.org/project/CherryPy/) | Object-Oriented HTTP framework | 18.9.0 | BSD  |
| [click](https://pypi.org/project/click/) | Composable command line interface toolkit | 8.1.7 | BSD-3-Clause |
| [cloudpickle](https://pypi.org/project/cloudpickle/) | Pickler class to extend the standard pickle | 3.0.0 | BSD-3-Clause |
...
| [conda-inject](https://pypi.org/project/conda-inject/) | Helper functions for injecting a conda environment into the current python environment (by modifying sys | 1.3.1 |  |
...
| [dpath](https://pypi.org/project/dpath/) | Filesystem-like pathing and searching for dictionaries | 2.1.6 | MIT |
...
| [fastjsonschema](https://pypi.org/project/fastjsonschema/) | Fastest Python implementation of JSON schema | 2.19.1 | BSD |
...
| [filelock](https://pypi.org/project/filelock/) | A platform independent file lock | 3.14.0 | The Unlicense (Unlicense) |
| [flake8](https://pypi.org/project/flake8/) | the modular source code checker: pep8 pyflakes and co | 7.0.0 | MIT |
| [flatbuffers](https://pypi.org/project/flatbuffers/) | The FlatBuffers serialization format for Python | 24.3.25 | Apache 2.0 |
| [fonttools](https://pypi.org/project/fonttools/) | Tools to manipulate font files | 4.51.0 | MIT |
...
| [frozenlist](https://pypi.org/project/frozenlist/) | A list-like structure which implements collections | 1.4.1 | Apache 2 |
| [future](https://pypi.org/project/future/) | Clean single-source support for Python 3 and 2 | 1.0.0 | MIT |
...
| [grpcio](https://pypi.org/project/grpcio/) | HTTP/2-based RPC framework | 1.64.0 | Apache License 2.0 |
| [h11](https://pypi.org/project/h11/) | A pure-Python, bring-your-own-I/O implementation of HTTP/1 | 0.14.0 | MIT |
...
| [immutables](https://pypi.org/project/immutables/) | Immutable Collections | 0.20 | Apache Software  |
| [importlib-metadata](https://pypi.org/project/importlib-metadata/) | Read metadata from Python packages | 7.1.0 | Apache Software  |
| [inflect](https://pypi.org/project/inflect/) | Correctly generate plurals, singular nouns, ordinals, indefinite articles | 7.2.1 | MIT  |
...
| [ipython](https://pypi.org/project/ipython/) | IPython: Productive Interactive Computing | 8.24.0 | BSD-3-Clause |
| [ipywidgets](https://pypi.org/project/ipywidgets/) | Jupyter interactive widgets | 8.1.2 | BSD 3-Clause License |
...
| [jsonpointer](https://pypi.org/project/jsonpointer/) | Identify specific nodes in a JSON document (RFC 6901) | 2.4 | Modified BSD License |
...
| [jupyter-client](https://pypi.org/project/jupyter-client/) | Jupyter protocol implementation and client libraries | 8.6.1 | BSD  |
...
| [jupyter-server](https://pypi.org/project/jupyter-server/) | The backend—i | 2.14.0 | BSD  |
...
| [jupyterlab](https://pypi.org/project/jupyterlab/) | JupyterLab computational environment | 4.2.0 | BSD  |
| [jupyterlab-pygments](https://pypi.org/project/jupyterlab-pygments/) | Pygments theme using JupyterLab CSS variables | 0.3.0 | BSD  |
| [jupyterlab-server](https://pypi.org/project/jupyterlab-server/) | A set of server components for JupyterLab and JupyterLab like applications | 2.27.1 | BSD  |
| [jupyterlab-widgets](https://pypi.org/project/jupyterlab-widgets/) | Jupyter interactive widgets for JupyterLab | 3.0.10 | BSD-3-Clause |
...
| [libclang](https://pypi.org/project/libclang/) | Clang Python Bindings, mirrored from the official LLVM repo: https://github | 18.1.1 | Apache License 2.0 |
| [lightgbm](https://pypi.org/project/lightgbm/) | LightGBM Python Package | 4.3.0 | MIT  |
...
| [more-itertools](https://pypi.org/project/more-itertools/) | More routines for operating on iterables, beyond itertools | 10.2.0 | MIT  |
...
| [nbconvert](https://pypi.org/project/nbconvert/) | Converting Jupyter Notebooks ( | 7.16.4 | BSD  |
...
| [notebook](https://pypi.org/project/notebook/) | Jupyter Notebook - A web-based notebook environment for interactive computing | 7.2.0 | BSD  |
| [notebook-shim](https://pypi.org/project/notebook-shim/) | A shim layer for notebook traits and config | 0.2.4 | BSD  |
| [numexpr](https://pypi.org/project/numexpr/) | Fast numerical expression evaluator for NumPy | 2.10.0 | MIT |
...
| [plac](https://pypi.org/project/plac/) | The smartest command line arguments parser in the world | 1.4.3 | BSD License |
| [platformdirs](https://pypi.org/project/platformdirs/) | A small Python package for determining appropriate platform-specific dirs, e | 4.2.2 | MIT  |
...
| [prompt-toolkit](https://pypi.org/project/prompt-toolkit/) | Library for building powerful interactive command lines in Python | 3.0.43 | BSD  |
...
| [PuLP](https://pypi.org/project/PuLP/) | PuLP is an LP modeler written in python | 2.8.0 | BSD  |
...
| [pycodestyle](https://pypi.org/project/pycodestyle/) | Python style guide checker | 2.11.1 | MIT |
| [pycparser](https://pypi.org/project/pycparser/) | C parser in Python | 2.22 | BSD-3-Clause |
| [pydata-sphinx-theme](https://pypi.org/project/pydata-sphinx-theme/) | Bootstrap-based Sphinx theme from the PyData community | 0.15.2 | BSD  |
...
| [pytest](https://pypi.org/project/pytest/) | pytest: simple powerful testing with Python | 8.2.1 | MIT |
...
| [python-gitlab](https://pypi.org/project/python-gitlab/) | A python wrapper for the GitLab API | 4.5.0 | LGPL-3.0-or-later |
...
| [pytorch-lightning](https://pypi.org/project/pytorch-lightning/) | PyTorch Lightning is the lightweight PyTorch wrapper for ML researchers | 2.2.4 | Apache-2.0 |
...
| [requests](https://pypi.org/project/requests/) | Python HTTP for Humans | 2.32.2 | Apache-2.0 |
...
| [reretry](https://pypi.org/project/reretry/) | An easy to use, but functional decorator for retrying on exceptions | 0.11.8 | Apache License 2.0 |
...
| [rise](https://pypi.org/project/rise/) | Reveal | 5.7.1 | BSD-3-Clause |
...
| [scipy](https://pypi.org/project/scipy/) | Fundamental algorithms for scientific computing in Python | 1.13.0 | BSD  |
...
| [snakemake](https://pypi.org/project/snakemake/) | Workflow management system to create reproducible and scalable data analyses | 8.11.6 | MIT |
...
| [sphinx-book-theme](https://pypi.org/project/sphinx-book-theme/) | A clean book theme for scientific explanations and documentation with Sphinx | 1.1.2 | BSD  |
| [sphinx-codeautolink](https://pypi.org/project/sphinx-codeautolink/) | Automatic links from code examples to reference documentation | 0.15.1 | MIT |
...
| [sympy](https://pypi.org/project/sympy/) | Computer algebra system (CAS) in Python | 1.12 | BSD |
...
| [tempora](https://pypi.org/project/tempora/) | Objects and routines pertaining to date and time (tempora) | 5.5.1 | MIT  |
...
| [terminado](https://pypi.org/project/terminado/) | Tornado websocket backend for the Xterm | 0.18.1 | BSD  |
...
| [throttler](https://pypi.org/project/throttler/) | Zero-dependency Python package for easy throttling with asyncio support | 1.2.2 | MIT |
| [tinycss2](https://pypi.org/project/tinycss2/) | A tiny CSS parser | 1.3.0 | BSD  |
| [toposort](https://pypi.org/project/toposort/) | Implements a topological sort algorithm | 1.10 | Apache Software  |
...
| [tornado](https://pypi.org/project/tornado/) | Tornado is a Python web framework and asynchronous networking library, originally developed at FriendFeed | 6.4 | Apache-2.0 |
...
| [typeguard](https://pypi.org/project/typeguard/) | Run-time type checker for Python | 4.2.1 | MIT |
...
| [typing-extensions](https://pypi.org/project/typing-extensions/) | Backported and Experimental Type Hints for Python 3 | 4.11.0 | Python |
...
| [urllib3](https://pypi.org/project/urllib3/) | HTTP library with thread-safe connection pooling, file post, and more | 2.2.1 | MIT  |
| [wcwidth](https://pypi.org/project/wcwidth/) | Measures the displayed width of unicode strings in a terminal | 0.2.13 | MIT |
| [webcolors](https://pypi.org/project/webcolors/) | A library for working with the color formats defined by HTML and CSS | 1.13 | BSD-3-Clause |
...
| [wheel](https://pypi.org/project/wheel/) | A built-package format for Python | 0.43.0 | MIT  |
| [widgetsnbextension](https://pypi.org/project/widgetsnbextension/) | Jupyter interactive widgets for Jupyter Notebook | 4.0.10 | BSD 3-Clause License |
...
| [yte](https://pypi.org/project/yte/) | A YAML template engine with Python expressions | 1.5.4 | MIT |
| [zipp](https://pypi.org/project/zipp/) | Backport of pathlib-compatible object wrapper for zip files | 3.18.2 | MIT  |
